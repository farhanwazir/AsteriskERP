...
(function($){
    ...
    DateTextEntry.prototype = {
        ...
        ,set_field_widths: function() {
            ...
            this.input_day.set_width  ( opt.field_width_day );
            this.input_month.set_width( opt.field_width_month );
            this.input_year.set_width ( opt.field_width_year );
        ...
        ,show_error: function() {
            ...
            if(error_text === '') {
                ...
                var x_offset = (opt.errorbox_x) + 'px';
                var y_offset = (this.wrapper.height() + opt.errorbox_y) + 'px';
